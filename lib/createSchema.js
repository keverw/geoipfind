module.exports = function(db, logFN, cb)
{
	...
	//lang_table
	cmds.table_lang = 'CREATE TABLE `lang` (`field` TEXT, `code` TEXT, `lookup_code` TEXT, `de` TEXT, `en` TEXT, `es` TEXT, `fr` INTEGER, `ja` INTEGER, `pt-BR` INTEGER, `ru` INTEGER, `zh-CN` INTEGER, PRIMARY KEY(field,code));';
