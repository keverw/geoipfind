module.exports = function(db, logFN, cb)
{
	...
	tables.geo_names = 'CREATE TABLE `geo_names` (`geoname_id`	INTEGER, `continent_code`	TEXT, `country_iso_code`	TEXT, `subdivision_1_iso_code`	TEXT, `subdivision_2_iso_code`	TEXT, `metro_code`	TEXT, `time_zone`	TEXT, PRIMARY KEY(geoname_id));';
