		...
		db.run('BEGIN TRANSACTION', function(err)
		{
			...
			else
			{
				...
				var statements = { //statements to create
					...
					geo_namesInsert: 'INSERT INTO geo_names (geoname_id, type, continent_code, country_iso_code, subdivision_1_iso_code, subdivision_2_iso_code, metro_code, time_zone) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
